...
public class Main {
	...
	public static void main(String[] args) {
		...
		livre.ajouterPlat(new Plat("Poisson pannée", 100, Difficulte.X,
				Cout.$$$$$, Plat.Type.DESSERT));
		livre.ajouterPlat(new Plat("Croquettes au fromage", 4, Difficulte.XXX,
				Cout.$$, Plat.Type.ENTREE));
		livre.ajouterPlat(new Plat("Houmous", 4, Difficulte.XXXXX,
				Cout.$$$$, Plat.Type.PLAT));
		...
		//3e test
		System.out.println("3e test");
		System.out.println("Livre Contenue (Vrai) : " + livre.contient(plat));
		System.out.println("Livre retirée (Vrai) : " + livre.supprimerPlat(plat));
		System.out.println("Livre contenue (Faux) : " + livre.contient(plat));
